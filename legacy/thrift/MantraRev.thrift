 ...
 * __________________
 *
 * Author: Shivelight (Arkie) <cawkfranchise@gmail.com>
 * GitHub: Shivelight
 * Date: 28 Jan 2018
 *
 * This Thrift IDL is based on reverse engineering and sniffing,
...
enum DeviceBooleanState {
    BEACON_AGREEMENT = 1;
    BLUETOOTH = 2;
    SHAKE_AGREEMENT = 3;
}

enum DeviceStringState {
    LOCATION_OS = 1;
    LOCATION_APP = 2;
    VIDEO_AUTO_PLAY = 3;
    HNI = 4;
...
struct BeaconQueryResponse {
    ...
    3: i64 cacheTtl;
    4: BeaconTouchActions touchAction;
...
struct Chatapp {
    ...
    3: string icon;
    4: string url;
    5: list<ChatType> availableChatTypes;
}

struct MyChatapp {
    1: Chatapp app;
    2: MyChatappCategory category;
    3: i64 priority;
}
...
struct LiffViewResponse {
    ...
    5: list<LiffViewFeature> features;
}
...
service BotService {
    ...
    BotUseInfo getBotUseInfo(
        2: string botMid) throws (1: TalkException e)
...
service TalkService {
    ...
    Settings getSettingsAttributes2(
        2: set<SettingsAttribute2> attrBitsetEx) throws (1: TalkException e);
    ...
    void reportSpammer(
        ...
        5: list<string> spamMesages) throws (1: TalkException e);
    ...
    void sendChatRemoved(
        ...
        2: string consumer,
        3: string lastMessageId,
        4: i8 sessiondId) throws (1: TalkException e);
    ...
    set<SettingsAttribute2> updateSettingsAttributes2(
        1: i32 reqSeq,
        3: Settings settings,
        4: set<SettingsAttribute2> attrBitsetEx) throws (1: TalkException e);
